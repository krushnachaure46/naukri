...
class RemoteJobsSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.naukri.com/jobapi/v3/search?\
                  ...
                  &searchType=adv&keyword=remote\
                  &pageNo=1&seoKey=remote-jobs\
                  &src=discovery_trendingWdgt_homepage_srch&latLong="]
        ...
        for j in payload['jobDetails']:
            ...
            while self.page <=page_count:
                ...
                base_url = "https://www.naukri.com/jobapi/v3/search?\
                  ...
                  &urlType=search_by_keyword\
                  &searchType=adv&keyword=remote\
                  &pageNo={}&seoKey=remote-jobs\
                  &src=discovery_trendingWdgt_homepage_srch&latLong=".format(self.page)
